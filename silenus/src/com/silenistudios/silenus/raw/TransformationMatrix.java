...
/** A transformation matrix is a 3x3 matrix containing scaling, shearing and
 * translation components, like this: [ a b tx ] [ c d ty ] [ 0 0 1 ] This is
 * the typical definition of an affine transformation.
 * @author Karel */
public class TransformationMatrix implements Serializable {
	...
	public String toString () {
		return "[" + fMatrix[0][0] + " " + fMatrix[0][1] + " ; " + fMatrix[1][0] + " " + fMatrix[1][1] + "] + [" + fTranslateX
			+ " " + fTranslateY + "]";
	}
