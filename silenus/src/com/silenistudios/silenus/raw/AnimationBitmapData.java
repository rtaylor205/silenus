...
/** This class contains all information about one particular bitmap on one frame
 * of an animation.
 * @author Karel */
public class AnimationBitmapData extends AnimationInstanceData {
	...
	public String getJSON () {
		...
		if (fColorManipulation != null)
			ss.append(",\"colorManipulation\":").append(getColorManipulation().getJSON());
		ss.append("}");
		return ss.toString();
	}
