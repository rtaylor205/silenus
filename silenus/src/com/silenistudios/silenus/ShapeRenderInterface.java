...
/** This interface is used to render a shape (using the pen tool for drawing)
 * directly in java. It can be passed to a Shape object and it will then draw
 * the entire shape in the correct color and shape.
 * @author Karel */
