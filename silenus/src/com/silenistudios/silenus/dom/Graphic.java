...
/** A graphic represents an instance of a bitmap in a scene, and contains
 * transformation data, sub-graphics etc for each sub-item that it contains. It
 * does not contain any transformation data about itself, as this is managed by
 * the parent object it is attached to, or by the dom document.
 * @author Karel */
