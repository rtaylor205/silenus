...
/** A single line piece used within a shape. Determines how to go from one point
 * to the next. I know this is not the best use for the word "line", but path is
 * already taken so this is the best I could come up with. This is not
 * necessarily a straight line; it may also be a more complex shape, such as a
 * curve.
 * @author Karel */
