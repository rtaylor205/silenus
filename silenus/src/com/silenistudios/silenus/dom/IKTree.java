 ...
 * in a layer. For now, we only get the x/y/rotation data, as we don't care
 * about simulating bone limitations.
 * @author Karel */
public class IKTree {
	...
	public Vector<TransformationMatrix> getTransformationMatrices (String referenceId) throws ParseException {
		if (!fChildren.containsKey(referenceId))
			throw new ParseException("Failed to find IK ChildNode with reference ID '" + referenceId + "'");
