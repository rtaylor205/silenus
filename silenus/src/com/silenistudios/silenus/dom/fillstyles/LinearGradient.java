...
/** Now this is probably the most curious thing I've encountered so far in the
 * XFL format, and there are quite a few things that make no sense at all. In
 * the XML format, a linear gradient is represented by a transformation matrix,
 * from which somehow the begin- and endpoints of the gradient must be derived.
 * After some puzzling and empirical estimation, I found that after transforming
 * [-1000,0] and [1000,0], you get something close to the begin- and endpoints
 * of the gradient. Don't ask me why.
 * @author Karel */
