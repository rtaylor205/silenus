...
/** This interface must be implemented to render a scene through the
 * SceneRenderer. SceneRenderer will call the appropriate functions at the right
 * time, to ensure that images are drawn in the correct position and
 * transformation. Notes: 1. If there's a feature you don't need or can't
 * support, leave the function empty. Save and restore are mandatory, though. 2.
